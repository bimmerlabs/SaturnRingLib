...
namespace SRL::Types
{
    ...
    struct Register : public RegisterBase
    {
        ...
        /** @brief If this Register was instantiated with AccessMode::Read, provide a pointer to the readable memory so callers can copy it
        ...
        /** @brief If this Register was instantiated with AccessMode::Write, copy the provided buffer into the memory-mapped region
